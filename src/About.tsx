...
export default function About(){
    return <>
        <h1>Welcome! </h1>
        <p>This is my notes and collections site!</p>
        <p>More specifically, I put this site together mainly by my interests in computer graphics and visual computing as a way to interactively put together some references for myself similar to a diary or blog, and I found this intuitive wrapper for webGL called threeJS. So I decided to see what is possible with it. </p>
