export default function About(){
    return <>
        ...
        <p>So to end my rant and spiel, if it's not apparent, I am a fullstack developer. Also with some additional expertise in visual computing, machine learning, and math. My interests lie in the intersections between data, visuals, and statistics, afterall: what is cooler than computing something you can use or see!</p>
        <div style={{height:"2vh"}}></div>
